...
HD_PWD='C:/FPGA/CHOICE-PUF/CHOICE_design/CHOICE_design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_pynq_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_pynq_wrapper.tcl
