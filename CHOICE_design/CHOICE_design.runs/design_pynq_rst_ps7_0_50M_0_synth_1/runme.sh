...
HD_PWD='C:/FPGA/CHOICE-PUF/CHOICE_design/CHOICE_design.runs/design_pynq_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_pynq_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_pynq_rst_ps7_0_50M_0.tcl
