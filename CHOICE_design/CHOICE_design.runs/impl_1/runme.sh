...
HD_PWD='C:/FPGA/CHOICE-PUF/CHOICE_design/CHOICE_design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_pynq_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_pynq_wrapper.tcl -notrace
